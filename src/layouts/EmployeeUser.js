...
import EmployeeSidebar from "components/Sidebar/EmployeeUser/EmployeeSidebar";
...
const switchRoutes = (
    <Switch>
        {routes.map((prop, key) => {
            if (prop.layout === "/employee" && prop.isAccordion !== true) {
                return (
                    <Route
...
export default function EmployeeUser(props) {
